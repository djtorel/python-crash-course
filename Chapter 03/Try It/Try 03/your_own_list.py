# Think of your favorite mode of transportation. Make a list that stores
...
print("I definitely want to own a " + cars[0])

print("I've heard the " + cars[1] + " is pretty sweet!")
