...
# as attributes. Write a method called give_raise() that adds $5000 to
...
class Employee():
    """Handles basic information about an Employee"""

    def __init__(self, first_name, last_name, salary):
        """Initialize name and salary for an employee"""
        self.first_name = first_name
        self.last_name = last_name
        self.salary = salary

    def give_raise(self, amount=5000):
        """Adds $5000 to the annual salary"""
        self.salary += amount
